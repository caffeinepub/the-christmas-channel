...
export class Backend implements backendInterface {
    ...
    async addDJ(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addDJ(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addShow(arg0: Show): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addShow(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDJs(): Promise<Array<DJ>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDJs();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getShowsForDay(arg0: bigint): Promise<Array<Show>> {
        if (this.processError) {
            try {
                const result = await this.actor.getShowsForDay(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeDJ(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeDJ(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async removeShow(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeShow(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
